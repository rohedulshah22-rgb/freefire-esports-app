    ...
    createMatch: adminProcedure
      .input(
        z.object({
          ...
          mapName: z.string(),
          customModeTag: z.string().trim().min(2).max(80).optional(),
          rulesSummary: z.string().trim().min(2).max(1_000).optional(),
          entryFee: z.number(),
          totalSlots: z.number(),
      ...
      .mutation(async ({ input, ctx }) => {
        console.log("[Admin] createMatch called with input:", {
          ...
          matchTitle: input.matchTitle,
            ...
            customModeTag: input.customModeTag,
        ...
        try {
          const result = await db.insert(matches).values({
            ...
            customModeTag: input.customModeTag || null,
